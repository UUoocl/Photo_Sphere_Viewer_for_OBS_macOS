...
function run_command()
    ...
    p = math.floor(((tonumber(string.sub(pt,0,pEnd-1))+450000)/900000)*100)
    -- Insta360 min and max tilt -300000 to +300000.  Scaled to 0-100
    t = math.floor(((tonumber(string.sub(pt,pEnd+6))+300000)/600000)*100)
    --output = p .." " .. t
    ...
    obs.script_log(obs.LOG_INFO, "Zoom Output: " .. z)
